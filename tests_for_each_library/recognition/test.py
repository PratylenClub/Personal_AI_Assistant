...
download the model in https://sourceforge.net/projects/cmusphinx/files/Acoustic%20and%20Language%20Models/French/
install http://macappstore.org/cmu-sphinxbase/
more information regarding the instalation of new languages https://github.com/Uberi/speech_recognition/blob/master/reference/pocketsphinx.rst
"""
